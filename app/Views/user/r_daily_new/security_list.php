									...
									<div class="d-flex justify-content-between">
										...
										<div class="d-flex my-xl-auto right-content">
                                            <div class="mb-3 mb-xl-0" style="margin-right: 10px;">
                                                <a href="<?=base_url('user/r_daily_new/security_add');?>" class="btn btn-success"><i class="mdi mdi-plus"></i> New Report</a>
                                            </div>
                                        </div>
									</div>
								</div>
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
											...
											<tbody>
												...
												<tr>
													...
													<td class="border-bottom-0"><?=$shift;?></td>
													<td class="border-bottom-0"><a href="<?=base_url('user/r_daily_new/security_detail/'.$row->id_daily_security_new);?>" class="btn btn-primary btn-with-icon btn-block"><i class="typcn typcn-eye"></i> View Report</a></th>
												</tr>
												<?php
													}
												?>
