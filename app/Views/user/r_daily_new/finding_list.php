...
<link href="<?=base_url('assets/main/');?>plugins/select2/css/select2.min.css" rel="stylesheet">
                    ...
                    <div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Security Report</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Daily Report / Daily Finding Report</span>
							</div>
						</div>
					</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Daily Finding Report</h4>
										<div class="d-flex my-xl-auto right-content">
                                            <div class="mb-3 mb-xl-0" style="margin-right: 10px;">
                                                <a href="<?=base_url('user/r_daily_new/finding_add');?>" class="btn btn-success"><i class="mdi mdi-plus"></i> New Report</a>
                                            </div>
                                        </div>
									</div>
								</div>
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
											<thead>
												<tr>
													...
													<th class="border-bottom-0" width="30%">Temuan</th>
											...
											<tbody>
												...
												<tr>
													...
													<td class="border-bottom-0"><?=$temuan;?></td>
													<td class="border-bottom-0"><a href="<?=base_url('user/r_daily_new/finding_detail/'.$row->id_daily_finding);?>" class="btn btn-primary btn-with-icon btn-block"><i class="typcn typcn-eye"></i> View Report</a></th>
												</tr>
												<?php
													}
												?>
