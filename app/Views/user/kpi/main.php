...
<link href="<?=base_url('assets/main/');?>plugins/select2/css/select2.min.css" rel="stylesheet">
                    ...
                    <div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Key Performance Indicator</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ List KPI</span>
							</div>
						</div>
					</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Key Performance Indicator</h4>
									</div>
								</div>
								<div class="card-body">
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
											<thead>
												<tr>
													...
													<th class="border-bottom-0" width="50%">Tahun</th>
													<th class="border-bottom-0" width="20%">Bulan</th>
													<th class="border-bottom-0" width="20%">Total Performance Index</th>
											...
											<tbody>
												<tr>
													...
													<td>2021</td>
													<td>September</td>
													<td><a href="<?=base_url('user/kpi/detail');?>" class="btn btn-primary btn-with-icon btn-block"><i class="typcn typcn-eye"></i> View Report</a></td>
												</tr>
											</tbody>
										</table>
									</div>
