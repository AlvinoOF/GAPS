<link href="<?=base_url('assets/main/');?>plugins/datatable/css/dataTables.bootstrap4.min.css" rel="stylesheet" />
    ...
    <link href="<?=base_url('assets/main/');?>plugins/select2/css/select2.min.css" rel="stylesheet">
                    ...
                    <div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Security Risk</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ List</span>
							</div>
						</div>
					</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Security Risk</h4>
										<div class="d-flex my-xl-auto right-content">
                                            <div class="mb-3 mb-xl-0" style="margin-right: 10px;">
                                                <a href="<?=base_url('user/securityrisk/tambah');?>" class="btn btn-success"><i class="mdi mdi-plus"></i> Tambah</a>
                                            </div>
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
											...
											<tbody>
												<tr>
													...
													<td><a href="<?=base_url('user/securityrisk/detail/1');?>" class="btn btn-success btn-with-icon btn-block"><i class="typcn typcn-eye"></i> Detail</a></td>
													<td><a href="<?=base_url('user/securityrisk/tindak/1');?>" class="btn btn-primary btn-with-icon btn-block"><i class="typcn typcn-eye"></i> Tindak Lanjut</a></td>
												</tr>
												<tr>
													<td>2</td>
													<td>Operasional produksi</td>
													<td><a href="<?=base_url('user/securityrisk/detail/2');?>" class="btn btn-success btn-with-icon btn-block"><i class="typcn typcn-eye"></i> Detail</a></td>
													<td><a href="<?=base_url('user/securityrisk/tindak/2');?>" class="btn btn-primary btn-with-icon btn-block"><i class="typcn typcn-eye"></i> Tindak Lanjut</a></td>
												</tr>
											</tbody>
										</table>
									</div>
