<link href="<?=base_url('assets/main/');?>plugins/datatable/css/dataTables.bootstrap4.min.css" rel="stylesheet" />
    ...
    <link href="<?=base_url('assets/main/');?>plugins/select2/css/select2.min.css" rel="stylesheet">
                    ...
                    <div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Security Document Control</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Standard Operation Procedure</span>
							</div>
						</div>
					</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Standard Operation Procedure</h4>
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
											...
											<tbody>
                                                <tr>
													<td>1</td>
													<td>2020-11-16</td>
													<td>GPNIDX 003 POST ORDER</td>
													<td>Rev 01</td>
													<td>
													<a href="<?=base_url('user_data/doc/sop/GPNIDX 003 POST ORDER.pdf');?>" class="btn btn-success btn-sm" target="_blank"><i class="typcn typcn-eye"></i> View/Download</a>
													</td>
                                                    <td></td>
                                                </tr>
												<tr>
													<td>2</td>
													<td>2020-11-16</td>
													<td>GPNIDX 004_Security Risk Assessment Guideline</td>
													<td>Rev 01</td>
													<td>
													<a href="<?=base_url('user_data/doc/sop/GPNIDX 004_Security Risk Assessment Guideline.pdf');?>" class="btn btn-success btn-sm" target="_blank"><i class="typcn typcn-eye"></i> View/Download</a>
													</td>
                                                    <td></td>
                                                </tr>
											</tbody>
