<link href="<?=base_url('assets/main/');?>plugins/datatable/css/dataTables.bootstrap4.min.css" rel="stylesheet" />
    ...
    <link href="<?=base_url('assets/main/');?>plugins/select2/css/select2.min.css" rel="stylesheet">
                    ...
                    <div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Security Document Control</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Corporate Sec Manual</span>
							</div>
						</div>
					</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Corporate Sec Manual</h4>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="example1" class="table key-buttons text-md-nowrap">
											<thead>
												<tr>
													<th class="border-bottom-0" style="text-align: center;">No</th>
													<th class="border-bottom-0" style="text-align: center;">Tanggal</th>
													<th class="border-bottom-0" style="text-align: center;">Jenis Dokumen</th>
													<th class="border-bottom-0" style="text-align: center;">Nama Dokumen</th>
													<th class="border-bottom-0" style="text-align: center;">Revisi</th>
													<th class="border-bottom-0" style="text-align: center;">Download</th>
													<th class="border-bottom-0" style="text-align: center;"></th>
												</tr>
											</thead>
											<tbody>
												<tr>
													...
													<td>BUKU PANDUAN KEAMANAN SOUTH QUARTER BUILDING</td>
													<td>Rev 01</td>
													<td><a href="<?=base_url('user_data/doc/corporate/operation_manual.pdf');?>" class="btn btn-success btn-sm" target="_blank"><i class="typcn typcn-eye"></i> View/Download</a></td>
													<td></td>
												</tr>
												<tr>
													<td>2</td>
													<td>2020-11-16</td>
													<td>SECURITY MANUAL</td>
													<td>GPNIDX 001 SECURITY MANAGMENT SYSTEM</td>
													<td>Rev 01</td>
													<td>
													<a href="<?=base_url('user_data/doc/corporate/GPNIDX 001 SECURITY MANAGMENT SYSTEM.pdf');?>" class="btn btn-success btn-sm" target="_blank"><i class="typcn typcn-eye"></i> View/Download</a>
													</td>
                                                    <td></td>
                                                </tr>
											</tbody>
