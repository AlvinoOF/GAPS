<link href="<?=base_url('assets/main/');?>plugins/datatable/css/dataTables.bootstrap4.min.css" rel="stylesheet" />
    ...
    <link href="<?=base_url('assets/main/');?>plugins/select2/css/select2.min.css" rel="stylesheet">
                    ...
                    <div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Monitoring & Evaluation</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Non-Conformity Report</span>
							</div>
						</div>
					</div>
									...
									<div class="d-flex justify-content-between">
										...
										<div class="d-flex my-xl-auto right-content">
                                            <div class="mb-3 mb-xl-0" style="margin-right: 10px;">
												<a href="<?=base_url('user/complaint/tambah');?>" class="btn btn-success"><i class="mdi mdi-plus"></i> Tambah</a>
											</div>
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
											<thead>
												<tr>
													...
													<th class="border-bottom-0">Complaint</th>
													<th class="border-bottom-0">Sugestion</th>
