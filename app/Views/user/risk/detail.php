							...
							<div class="card mg-b-20">
								...
								<div class="card-body">
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>Orang  Yang Akan Ditemui</td>
                                            <td>:</td>
                                            <td><?=$data->temui;?></td>
                                        </tr>
                                        <tr>
                                            <td>Personnel Yang Berkunjung</td>
                                            <td>:</td>
                                            <td></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="100%" border="1">
                                        ...
                                        <?php
                                            $tamu = json_decode($data->pengunjung);
                                            $no=0;
                                            if(is_array($tamu)){
                                                foreach($tamu as $row){
                                                    $no++;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td width="5%">:</td>
                                            <td width="30%"><?=$data->kendaraan;?></td>
                                            <td width="40%">No. Kendaraan : <?=$data->no_kendaraan;?></td>
                                        </tr>
                                        <tr>
