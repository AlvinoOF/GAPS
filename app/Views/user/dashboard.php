						...
						<div class="col-sm-12 col-lg-6">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										<!-- <div class="col text-center">
											<p><a href="<?=base_url('user/dashboard/video/1');?>" target="_blank" class="btn btn-info-gradient btn-block">Point 1</a></p>
										</div>
										<div class="col border-left text-center">
											<p><a href="<?=base_url('user/dashboard/video/2');?>" target="_blank" class="btn btn-info-gradient btn-block">Point 2</a></p>
										</div>
										<div class="col border-left text-center">
											<p><a href="<?=base_url('user/dashboard/video/3');?>" target="_blank" class="btn btn-info-gradient btn-block">Point 3</a></p>
										</div> -->
										<div class="col text-center">
											<p><button onclick="myFunction(this)" value="1" class="btn btn-info-gradient btn-block">Ind 01</button></p>
										</div><!-- col -->
										<div class="col border-left text-center">
											<p><button onclick="myFunction(this)" value="2" class="btn btn-info-gradient btn-block">Ind 02</button></p>
										</div><!-- col -->
										<div class="col border-left text-center">
											<p><button onclick="myFunction(this)" value="3" class="btn btn-info-gradient btn-block">Ind 03</button></p>
										</div><!-- col -->
										<script>
										function myFunction(btn) {
											window.open("<?=base_url('user/dashboard/video/');?>"+btn.value, "CCTV"+btn.value, "toolbar=no,scrollbars=no,resizable=no,top=500,left=500,width=736,height=426");
										}
										</script>
									</div>
								</div>
