				...
				<div class="main-sidemenu">
					<div class="app-sidebar__user clearfix">
						<div class="dropdown user-pro-body">
							<div class="">
								<img alt="user-img" class="avatar avatar-xl brround" src="<?=base_url('assets/images/');?>no_profile.jpg"><span class="avatar-status profile-status bg-green"></span>
							</div>
							<div class="user-info">
								<h4 class="font-weight-semibold mt-3 mb-0"><?=$this->session->userdata('nama_lengkap');?></h4>
								<span class="mb-0 text-muted"><?=$this->session->userdata('jabatan');?> - <?=$this->session->userdata('perusahaan');?></span>
							</div>
						</div>
					</div>
						...
						<div class="main-header-left ">
							...
							<div class="main-header-center ml-3 d-sm-none d-md-none d-lg-block">
								<?php if($this->session->userdata('auth') == 'admin'){ ?>
									client : <h4><a href=""><?=$this->session->userdata('client');?></a></h4>
								<?php }elseif($this->session->userdata('auth') == 'user'){ ?>
								<h4><?=$this->session->userdata('perusahaan');?></h4>
								<?php } ?>
							</div>
						</div>
						<div class="main-header-right">
							<div class="nav nav-item  navbar-nav-right ml-auto">
									...
									<div class="dropdown-menu">
										...
										<div class="main-message-list chat-scroll">
											<a href="#" class="p-3 d-flex border-bottom">
												<div class="  drop-img  cover-image  " data-image-src="<?=base_url('assets/main/');?>img/faces/3.jpg">
											...
											<a href="#" class="p-3 d-flex border-bottom">
												<div class="drop-img cover-image" data-image-src="<?=base_url('assets/main/');?>img/faces/2.jpg">
													<span class="avatar-status bg-teal"></span>
												</div>
												<div class="wd-90p">
													<div class="d-flex">
											...
											<a href="#" class="p-3 d-flex border-bottom">
												<div class="drop-img cover-image" data-image-src="<?=base_url('assets/main/');?>img/faces/9.jpg">
													<span class="avatar-status bg-teal"></span>
												</div>
												<div class="wd-90p">
													<div class="d-flex">
											...
											<a href="#" class="p-3 d-flex border-bottom">
												<div class="drop-img cover-image" data-image-src="<?=base_url('assets/main/');?>img/faces/12.jpg">
													<span class="avatar-status bg-teal"></span>
												</div>
												<div class="wd-90p">
													<div class="d-flex">
											...
											<a href="#" class="p-3 d-flex border-bottom">
												<div class="drop-img cover-image" data-image-src="<?=base_url('assets/main/');?>img/faces/5.jpg">
													<span class="avatar-status bg-teal"></span>
												</div>
												<div class="wd-90p">
													<div class="d-flex">
								...
								<div class="dropdown main-profile-menu nav nav-item nav-link">
									<a class="profile-user d-flex" href=""><img alt="" src="<?=base_url('assets/images/');?>no_profile.jpg"></a>
									<div class="dropdown-menu">
										<div class="main-header-profile bg-primary p-3">
											<div class="d-flex wd-100p">
												<div class="main-img-user"><img alt="" src="<?=base_url('assets/images/');?>no_profile.jpg" class=""></div>
												<div class="ml-3 my-auto">
													<h6><?=$this->session->userdata('nama_lengkap');?></h6>
													<span><?=$this->session->userdata('jabatan');?> - <?=$this->session->userdata('perusahaan');?></span>
												</div>
											</div>
										</div>
										...
										<a class="dropdown-item" href="<?=base_url('welcome/logout');?>"><i class="bx bx-log-out"></i> Sign Out</a>
									</div>
								</div>
							</div>
						</div>
